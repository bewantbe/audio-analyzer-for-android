...
* Fine exam the spectrum by gestures: e.g pinch for scaling and swipe for  view move.
...
* Can do averages of several spectrum then plot, make the spectrum more smooth for steady input.
